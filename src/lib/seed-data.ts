...
export const salesTerritories: SalesTerritory[] = [
  {
    ...
    lichTheoNgay: [
      { dayName: "Thứ 2", clusterIds: ["Q1-A"] },
      { dayName: "Thứ 3", clusterIds: ["Q1-B"] },
    ],
    minVisitsPerDay: 6,
    maxVisitsPerDay: 15,
  ...
  },
  {
    ...
    lichTheoNgay: [
      { dayName: "Thứ 2", clusterIds: ["Q3-A"] },
      { dayName: "Thứ 5", clusterIds: ["PN-A"] },
    ],
    minVisitsPerDay: 6,
    maxVisitsPerDay: 15,
  ...
  },
  {
    ...
    lichTheoNgay: [
      { dayName: "Thứ 2", clusterIds: ["TB-A"] },
      { dayName: "Thứ 6", clusterIds: ["BT-A"] },
      { dayName: "Thứ 7", clusterIds: ["GV-A"] },
    ],
    minVisitsPerDay: 7,
    maxVisitsPerDay: 14,
  ...
  },
  {
    ...
    lichTheoNgay: [
      { dayName: "Thứ 3", clusterIds: ["TP-A"] },
      { dayName: "Thứ 4", clusterIds: ["BTA-A"] },
      { dayName: "Thứ 5", clusterIds: ["TD-A"] },
    ],
    minVisitsPerDay: 5,
    maxVisitsPerDay: 13,
